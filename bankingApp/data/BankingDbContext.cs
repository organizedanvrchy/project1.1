...
public class BankingDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.Username).HasMaxLength(25).IsUnicode(false).HasColumnName("username");
            entity.Property(e => e.PasswordHash).HasMaxLength(60).IsUnicode(false).HasColumnName("password_hash");

            entity.Property<string>("user_type").HasMaxLength(20).IsUnicode(false);
        ...
        modelBuilder.Entity<BankAccount>(entity =>
        {
            ...
            entity.Property(e => e.Balance).HasColumnType("decimal(19,4)").HasColumnName("balance");

            entity.Property<string>("account_type").HasMaxLength(20).IsUnicode(false);
        ...
        {
            entity.Property(e => e.WithdrawalLimitPerMonth).HasColumnName("withdrawal_limit_per_month");
            entity.Property(e => e.WithdrawalsThisPeriod).HasColumnName("withdrawals_this_period");
        ...
        modelBuilder.Entity<Transaction>(entity =>
        {
            ...
            entity.Property(e => e.TransactionAmount).HasColumnType("decimal(19,4)").HasColumnName("transaction_amount");
        ...
        modelBuilder.Entity<ChequeBookRequest>(entity =>
        {
            ...
            entity.Property(e => e.AccountId).HasColumnName("account_id");
            entity.Property(e => e.RequestDate).HasDefaultValueSql("(getdate())").HasColumnName("request_date");
            ...
            entity.Property(e => e.RequestApprovedDate).HasColumnName("request_approved_date");
